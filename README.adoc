...
*Fault-tolerant long-term storage solution is built over 2 data disks* (/dev/sda and /dev/sdc). Several storage solutions were considered when designing the storage system.
