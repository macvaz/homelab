...
This minipc is intended to host 1 on-site fault-tolerant backup for my family media (photos and videos). Consequently, I added two external USB disk drives and create a RAID 1 to meet fault-tolerance requirement. At the end if this section, the minipc will become a homemade NAS server.
