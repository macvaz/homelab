...
*I describe how to create a software based NAS storage* based on a pair of 1 TB external USB disks in section 4 (External storage).
...
This minipc is intended to host 1 on-site fault-tolerant backup for my family media (photos and videos). Consequently, I added two extra USB disk drives and create a RAID 1 with them.
