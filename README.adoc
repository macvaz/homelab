...
All data management tasks are centralized in the OMV VM (nas_vm): managind disks, creating file systems, RAID devices, SMB shares, users, access policies, etc. The only data management task done by proxmox with data disks is the SMART scans and alerts.
