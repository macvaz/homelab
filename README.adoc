...
image::img/kvm_extender.png[KVM extender,150,300]
...
A logical architecture diagram of the services running in the "proxmox1" hyper-converged node is presented here:
