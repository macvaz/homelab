...
*Fault-tolerant long-term storage solution needs to be built* over two 1 TB SSD data disks (/dev/sda and /dev/sdc). Several storage solutions were considered when designing the storage system.
