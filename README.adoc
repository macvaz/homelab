...
Selecting devices with small form factors is a must. Power efficiency is also mandatory for devices that operate 24x7 but normally running low computational load.
