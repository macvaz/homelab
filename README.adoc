...
In the next logical architecture diagram, the main software services running in the homelab are presented. This diagram includes services running in both bare-metal infrastructure (hypervisor) and the above described virtual machines.
