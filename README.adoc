...
Selecting devices with small form factors is a must. In addition, power efficiency is also mandatory for this kind of devices as they operate 24x7 but normally running low computational load. Relying on virtualization may help in both aspects.
