...
This approach doesn't required specialized hardware appliances for storage (ej: NAS appliance) and computing. Both kind of infrastructures can be virtualized by software using a hypervisor. In this homelab, Proxmox VE was use as Type 1 hypervisor.
