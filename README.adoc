...
Above containers are deployed in *2 different docker-compose stacks* (homelab and portainer). All docker-related information can be found https://github.com/macvaz/homelab/blob/main/docker[here].
