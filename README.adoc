...
**This networking setup creates a Linux bridge interface (vmbr0) to which all virtual servers are connected.** This bridge is also connected to the physical NIC, reusing DHCP server and internet gateway from my Mikrotik router.
