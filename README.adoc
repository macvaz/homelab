...
*Fault-tolerant long-term storage solution needs to be built over 2 1TB SSD data disks* (/dev/sda and /dev/sdc). Several storage solutions were considered when designing the storage system.
