...
Once both virtual servers -storage and applications- are described, it's time to deploy customer-facing applications over them. In the following sections, a *functional description* of the applications and a complete *logical architecture diagram* are presented. 
