...
Once virtual servers -storage and applications- are described, it's time to show what *applications and services* ara available in the homelab. In the following sections, a *functional description* of the applications and a complete *logical architecture diagram* are presented. 
