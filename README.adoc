...
This minipc is intended to *host 1 on-site fault-tolerant backup for my family media (photos and videos)*. Consequently, I added two external USB disk drives and created a RAID 1 device to meet fault-tolerance requirement. At the end if this section, the minipc becomes a homemade NAS server.
